(function () {
  ...
  describe('Bot users List Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _UserDialogsService_) {
      ...
      UserDialogsListController = $controller('UserDialogsListController as vm', {
        $scope: $scope
      });
    ...
    describe('Instantiate', function () {
      var mockUserDialogList;

      beforeEach(function () {
        mockUserDialogList = [mockUserDialog, mockUserDialog];
      });
      ...
      it('should send a GET request and return all Bot users', inject(function (UserDialogsService) {
        ...
        expect($scope.vm.userDialogs.length).toEqual(2);
        expect($scope.vm.userDialogs[0]).toEqual(mockUserDialog);
        expect($scope.vm.userDialogs[1]).toEqual(mockUserDialog);
