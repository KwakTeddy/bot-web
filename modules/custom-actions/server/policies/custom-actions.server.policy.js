...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    roles: ['admin'],
    allows: [{
      resources: '/api/custom-actions',
      permissions: '*'
    }, {
      resources: '/api/custom-actions/:customActionId',
      permissions: '*'
    }]
  }, {
    roles: ['user'],
...
exports.isAllowed = function (req, res, next) {
  ...
  if (req.customAction && req.user && req.customAction.user && req.customAction.user.id === req.user.id) {
    return next();
  }
