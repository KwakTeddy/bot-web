...
angular.module('authentication').controller('AuthenticationController', ['$scope', '$state', '$http', '$location', '$window', 'Authentication', 'PasswordValidator', '$uibModal', '$rootScope', '$stateParams', '$cookies', '$timeout',
  function ($scope, $state, $http, $location, $window, Authentication, PasswordValidator, $uibModal, $rootScope, $stateParams, $cookies, $timeout) {
    var vm = this;
