...
angular.module('playchat').controller('HeaderController', ['$scope', '$location', '$timeout', '$cookies', 'Authentication', function ($scope, $location, $timeout, $cookies, Authentication)
{
    $scope.isLogin = $cookies.get('login');
