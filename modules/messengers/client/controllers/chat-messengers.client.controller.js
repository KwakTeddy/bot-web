...
angular.module('messengers').controller('ChatMessengersController', ['$scope', '$document', 'Authentication', 'Socket',
  function ($scope, $document, Authentication, Socket) {
    ...
    function addBotBubble(msg) {
      ...
      bubble.setAttribute('class', 'item item-avatar b-none friend');
      bubble.innerHTML =
        '<img src="/images/venkman.jpg">' +
        '<div class="text-xs"><span class="font-bold m-r-sm">'+vm.bot+'</span><span class="color-grey-500">1:35PM</span></div>' +
        '<div class="bubble"><i class="icon-tail"></i><span class="content">' + msg + '</span></div>';
    ...
    function addUserBubble(msg) {
      ...
      bubble.innerHTML =
        '<div class="text-xs"><span class="font-bold m-r-sm"></span><span class="color-grey-500">1:35PM</span></div>' +
