(function()
{
    ...
    angular.module('playchat').controller('BizDialogGraphEntityAddController', ['$scope', '$resource', '$cookies', '$timeout', '$element', 'CaretService','LanguageService', function ($scope, $resource, $cookies, $timeout, $element, CaretService, LanguageService)
    {
