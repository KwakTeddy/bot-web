(function () {
  ...
  ChannelsListController.$inject = ['ChannelsService', '$scope', '$cookies', '$uibModal', '$http', 'Authentication', '$window'];

  function ChannelsListController(ChannelsService, $scope, $cookies, $uibModal, $http, Authentication, $window) {
    var vm = this;
