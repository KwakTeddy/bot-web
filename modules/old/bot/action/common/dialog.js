...
var botUser= require(path.resolve('modules/bot/bot-users/server/controllers/bot-users.server.controller'))
var userDilaog = require(path.resolve('modules/bot/user-dialogs/server/controllers/user-dialogs.server.controller'));
