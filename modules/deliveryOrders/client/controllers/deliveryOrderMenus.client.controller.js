(function () {
  ...
  angular
    ...
    .controller('DeliveryOrderMenusController', DeliveryOrderMenusController);

  DeliveryOrderMenusController.$inject = ['$scope', '$state', 'Authentication', 'menuResolve'];

  function DeliveryOrderMenusController($scope, $state, Authentication, menus) {
    var vm = this;
    ...
    function save(isValid) {
      ...
      function successCallback(res) {
        $state.go('deliveryOrders.list', {
          deliveryOrderId: res.deliveryOrder
        }, {reload: true});
      }
