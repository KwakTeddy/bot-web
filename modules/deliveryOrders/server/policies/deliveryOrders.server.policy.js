...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    roles: ['admin'],
    allows: [{
      resources: '/api/deliveryOrders',
      permissions: '*'
    }, {
      resources: '/api/deliveryOrders/:deliveryOrderId',
      permissions: '*'
    }]
  }, {
    roles: ['user'],
...
exports.isAllowed = function (req, res, next) {
  ...
  if (req.deliveryOrder && req.user && req.deliveryOrder.user && req.deliveryOrder.user.id === req.user.id) {
    return next();
  }
