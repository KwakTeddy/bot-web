                ...
                "children": [
                    {
                        ...
                        "output": [
                            {
                                "kind": "Content",
                                "text": "1개월 체납일 경우 '독촉장'이 나가며 \n2개월 체납일 경우 '공급중지 예고서'가 \n발송됩니다.\n중지예고서의 기간내에 납부하지 않은 경우 부득이 가스 공급이 중지됩니다.\n중지 후 재공급 시 익월요금에 \n해제수수료(2,200원/건)가 \n부과되므로 참고하시기 바랍니다.\n혹, 이미 중단이 되셨다면 체납금을 \n납부 하신 후 해당 고객센터로 \n연락하시어 재공급을 받으시면 됩니다.",
                                "buttons": [
                                    {
                                        "text": "이전"
                                    },
                    ...
                    },
                    {
                        ...
                        "output": [
                            {
                                "kind": "Content",
                                "text": "자동이체 신청 시 삼천리, 금융결제원, 해당은행간 실명제확인 절차로 인해 일정 시일이 소요될 수 있어\n\n정확한 적용시점을 안내드리기 어렵습니다.  자동이체 적용 완료시 고지서상에 자동이체로 표시되오니,\n\n자동이체 표시된 고지서를 받기 전까지는 별도의 방법으로 요금을 납부하여 주시기 바랍니다.\n\n자동이체는 고객님의 납기일 3일 전에 금융결제원으로 청구자료가 발송되어 중복납부되실 수 있사오니,\n\n해지시 주의하여 주시길 부탁드립니다.",
                                "buttons": [
                                    {
                                        "text": "이전"
                                    },
