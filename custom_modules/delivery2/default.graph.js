						...
						"output": [
							{
								...
								"call": "주문목록",
								"options": {
									"output": "*배달가능한 최소가격은 +restaurant.minPrice+입니다.*[주문 목록]#cart#[+name+] X+quant+, +price+원 # 1. 주문 완료 2. 메뉴 추가 3. 메뉴 삭제 4. 메뉴 수량변경 5. 주문 취소  * 처음으로 가시려면 '처음' 또는 0번, 이전단계로 가시러면 '이전' 또는 9번을 입력해주세요."
								}
							}
						]
					},
...
var _bot = require(require('path').resolve("config/lib/bot")).getBot('delivery2');
