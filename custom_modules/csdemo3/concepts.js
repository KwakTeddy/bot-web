...
var concepts = {
  ...
  '약냉': ['약냉', '안 시원하다', '안 차갑다', '약하다', '녹다', '미지근하다', '따뜻하다', '덥다', '시원하다 않다','모터 약하다', '송풍 처럼', '상 하다', '상해','온도 내려가다 않다', '안 내려가다','약해지다','덜 시원하다','안 시원','시원 안 해요','시원 안해 요','안 쎄','얼다 않다','강하다 않다'],
  '강냉': ['강냉', '세다', '세', '얼다','강하다','쎄', '세요', '세요'],
  '무냉': ['무냉', '안 되다', '안 돼다', '멈추다', '안 나오다', '나오다 않다','가스 나가다','가스 없다','모터 안 돌아가다','냉기 없다', '작동 안해','작동 안 해','밉다 작동','작동 안함','안나 와','안나 옴','꺼지다'],
