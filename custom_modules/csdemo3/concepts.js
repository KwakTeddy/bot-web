...
var concepts = {
  ...
  '냉장고' : ['냉장고', '디오스', '싱싱', '냉동고', '시그니쳐', 'SIGNATURE', 'refrigerator', 'DIOS', 'dios', 'SINGSING', 'singsing'],
  '에어컨': ['에어컨', '휘센', '에어콘', 'airconditoner', 'air', 'WHISEN', 'whisen'],
  '약냉': ['약냉', '안 시원하다', '안 차갑다', '약하다', '녹다', '미지근하다', '따뜻하다', '덥다', '시원하다 않다','모터 약하다', '송풍 처럼', '상하다','온도 내려가다 않다', '안 내려가다'],
  '강냉': ['강냉', '세다', '얼다'],
  '무냉': ['무냉', '안 되다', '안 돼다', '멈추다', '안 나오다', '나오다 않다','가스 나가다','가스 없다','모터 안 돌아가다'],
