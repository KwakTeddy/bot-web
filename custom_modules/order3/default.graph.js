...
var commonDialogs = [
    ...
    { "id": "defaultcommon1", "filename": "defaultcommon", input: {if: 'context.dialog.menus && context.dialog.menus.length > 0', regexp: /(?:여기|까지|주문)/}, output: {call: '주문확인'}},
    { "id": "defaultcommon2", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /전화/}, output: {call: '전화주문'}},
    { "id": "defaultcommon3", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /(?:~이전|^0$)/}, output: {up : 1}},
    { "id": "defaultcommon4", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /(?:~전페이지|^<$)/}, output: {repeat: 1, options: {page: 'pre'}}},              // TODO 이전페이지, 다음페이지 구현
    { "id": "defaultcommon5", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /(?:~다음|^>$)/}, output: {repeat: 1, options: {page: 'next'}}},
    { "id": "defaultcommon6", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /(?:빼다|삭제|취소|~변경)/, types: [orderTasks.cartType]},output: {returnCall: '메뉴삭제1'} },
    ...
    { "id": "defaultcommon7", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /추가/g, types: [orderTasks.menuType]}, output: [
    ...
    { "id": "defaultcommon8", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /(?:(?:(?:음식점|가게|매장).*~변경)|(?:(?:다른\s*곳|다른\s*데|다른\s*대).*~배달))/g}, output: {returnCall: '음식점입력'}  },
    { "id": "defaultcommon9", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /주소.*~변경/g}, output: {returnCall: '주소등록'}},
    { "id": "defaultcommon10", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /~휴대폰.*~변경/g}, output: {returnCall: '휴대폰번호등록'}  },
    // { input: {if: orderTypes.orderDialogCondition, regexp: /(?:여기|그만).*~배달/}, output: {returnCall: '주문확인'}},
    { "id": "defaultcommon11", "filename": "defaultcommon", input: {if: orderTypes.orderDialogCondition, regexp: /(?:~처음|^!$|취소)/}, output: {returnCall: '주문취소'}},
    { "id": "defaultcommon12", "filename": "defaultcommon", name: dialogModule.NO_DIALOG_NAME, output: [
        ...
        children: [
            {
                "id": "defaultcommon13", "filename": "defaultcommon",
                input: /~네/,
                output: {call: '배달주문', options: {top: '배달주문'}}
            },
            {
                "id": "defaultcommon14", "filename": "defaultcommon",
                input: '~아니요',
...
var dialogs = [
    { "id": "default0", "filename": "default", name: '주소확인', input: /주소.*(?:확인|무엇|뭐|알다)/, output: '현재 주소는 +address.지번주소+ 입니다.'},

    { "id": "default1", "filename": "default", name: '주소등록', input: {regexp: /주소.*~변경/g},
        output: '지번 또는 도로명을 포함한 상세주소를 말씀해주세요.',
        children: [
            { "id": "default2", "filename": "default", input: {types: [{type: type.addressType, raw: true, context: true}]},
                output: [
                    { if: 'context.dialog.address.지번본번 == undefined && context.dialog.forceAddress != true',
                        ...
                        children: [
                            {"id": "default3", "filename": "default", input: '계속', output: {call: '주소등록확인'}},
                            {"id": "default4", "filename": "default", output: {callChild: '주소등록'}}
                        ]},
                    ...
                    { if: 'context.dialog.address.상세주소 == undefined', output: '동호수나 몇층인지 까지 말씀해주세요.\n 있으면 말씀해주시고, 이게 전부이면 "거기까지"라고 얘기해주세요.',
                        children: [
                            {"id": "default5", "filename": "default", input: '거기까지', output: {call: '주소등록확인'}},
                            { "id": "default6", "filename": "default", task: { action: function(task, context, callback) {
            ...
            { "id": "default7", "filename": "default", name: '주소등록확인',
                input: false,
                output: [
                    {
                        ...
                        children: [
                            {"id": "default8", "filename": "default", input: /~네/, output: {call: '주소변경완료'}},
                            {"id": "default9", "filename": "default", input: /~아니요/, output: {call: '주소등록'}},
                            {"id": "default10", "filename": "default", output: {repeat: 1, options: {prefix: '네 혹은 아니오로 대답해주세요.\n'}} }
                        ]},
                    {if: 'true', output: {call: '주소변경완료'}}
                ]
            },
            { "id": "default11", "filename": "default", input: false,
                name: '주소변경완료',
            ...
            { "id": "default12", "filename": "default", output: {repeat: 1, options: {output: '번지수 및 동호수를 포함한 상세주소를 말씀해주세요.\n예시) 강남구 삼성동 16-1 101동 101호\n예시) 강남구 학동로 426 101동 101호\n\n주소를 정확히 입력해 주세요.\n0.이전 !. 처음 | 상세주소를 말씀해주세요'}}}
        ]
    },

    { "id": "default13", "filename": "default", name: '휴대폰확인', input: /휴대폰.*(?:확인|무엇|뭐|알다)/, output: '현재 휴대폰번호는 +mobile+ 입니다.'},

    { "id": "default14", "filename": "default", name: '휴대폰번호등록', input: {regexp: /~휴대폰.*~변경/g},
        output: '휴대폰번호를 말씀해주세요.',
        children: [
            { "id": "default15", "filename": "default", name: 'SMS발송',
                ...
                output: [
                    ...
                    {"kind": "Action", "call": "SMS인증"}   // TODO output에 1개 목록 있을 때 task 두번 호출되는 현상
                ]
            },
            { "id": "default16", "filename": "default", name: 'SMS인증',
                input: false,
                output: '문자메세지(SMS)로 발송된 인증번호를 입력해주세요.',
                children: [
                    {
                        "id": "default17", "filename": "default", name: 'SMS재발송',
                        input: '발송',
                        output: {call: 'SMS발송'}
                    },
                    { "id": "default18", "filename": "default", name: 'SMS재인증',
                        input: /[\d\s]+/,
                        output: [
                            ...
                            {"kind": "Action", "call": "SMS인증", options: {prefix: '인증번호가 틀렸습니다.\n', postfix: '\n0. 이전\n!. 처음'}}
                        ]},
    ...
    {
        "id": "default19", "filename": "default", name: '배달주문',
        input: [
            /~배달/,
        ...
        task: {action: function(task, context, callback) {
            ...
            //context.user.address = "서울시 관악구 봉천동 1645-55 201호";
        }},
        output: {call: '주소입력'},
        children: [
            { "id": "default20", "filename": "default", name: '주문취소', input: false, output: '주문을 취소하고 처음으로 가시겠습니까?',
                children: [
                    { "id": "default21", "filename": "default", input: {regexp: /~네/g},
                        task: {action: function(task, context, callback) {
                            context.botUser.returnCall = null;
                            callback(task, context);}
                        },
                        output: {callGlobal: '시작'} },
                    { "id": "default22", "filename": "default", input: {regexp: /~아니요/g}, output: {output: '주문을 계속 하겠습니다', return: 1} },
                    { "id": "default23", "filename": "default", output: {repeat: 1, output: '주문을 취소 하시려는지 아닌지 모르겠습니다.\n주문을 취소하시려면 "네",\n취소하지 않으시려면 "아니요"" 라고 말씀해주세요.'}}
                ]
            },

            { "id": "default24", "filename": "default", name: '주소입력', input: false,
                output: [
                    { if: 'context.user.address',
                        ...
                        output: {call: '휴대폰번호입력'}},
                    // { output: {returnCall: '주소등록', options: {returnDialog: '휴대폰번호입력'}}} TODO

                        {
                            "kind": "Action",
                            "returnCall": "주소등록",
                            options: {returnDialog: '휴대폰번호입력'}
                        }

                ]
            },

            { "id": "default25", "filename": "default", name: '휴대폰번호입력', input: false,
                output: [
                    {
                    ...
                    },
                    {
                        "kind": "Action",
                        "returnCall": "휴대폰번호등록",
                        options: {returnDialog: '영업시간체크'}
                    },
                    //{returnCall: '휴대폰번호등록', options: {returnDialog: '영업시간체크'}} TODO
                ]
            },

            { "id": "default26", "filename": "default", name: '영업시간체크', input: false,
                output: [
                    {if: function(dialog, context, callback) {
            ...
            { "id": "default27", "filename": "default", name: '음식점입력',
                input: false,
                output: '주문할 메뉴나 음식점을 말씀해 주세요~',
                children: [
                    { "id": "default28", "filename": "default", name: '음식점메뉴단일',
                        ...
                        children: [
                            { "id": "default29", "filename": "default", input: /~네/,
                                task: {
                                ...
                                output: {call: '메뉴추가확인'}},
                            { "id": "default30", "filename": "default", output: {callChild: '음식점입력'}}
                        ]
                    },

                    { "id": "default31", "filename": "default", input: {types: [orderTask.restaurantType]},
                        output: [
                            { if: '!Array.isArray(dialog.task.restaurant)',
                                ...
                                children: [
                                    { "id": "default32", "filename": "default", input: /~네/,
                                        ...
                                        output: {call: '메뉴선택'}},
                                    { "id": "default33", "filename": "default", input: /~아니요/, output: {callChild: '음식점입력'}},
                                    { "id": "default34", "filename": "default", output: {callChild: '음식점입력'}}
                                ]
                            },

                            { "id": "default35", "filename": "default", if: 'Array.isArray(dialog.task.restaurant)',
                                name: '음식점목록',
                                output: '가장 적합한 음식점들을 찾았습니다. \n#restaurant#+index+. +name+ +openStatus+\n#0. 이전 \n!. 처음(주문취소)\n\n목록에서 번호나 음식점명을 입력해주세요|목록에서 선택해 주세요',
                                children: [
                                    { "id": "default36", "filename": "default", input: {types: [{name: 'orderRestaurant', listName: 'restaurant', typeCheck: 'listTypeCheck'}]},
                                        output: [
                                    ...
                                    { "id": "default37", "filename": "default", input: {types: [{type: orderTask.restaurantType, failSave: false}]}, output: {callChild: '음식점입력'}},
                                    { "id": "default38", "filename": "default", input: [/전단지/, /전단/, /^ㅈㄷㅈ$/], output: {call: '음식점구분'}},
                                    { "id": "default39", "filename": "default", output: {repeat: 1, options: {prefix: '목록에 있는 번호나 음식점을 입력해 주세요!\n\n'}}}
                                ]
                            }
                        ]
                    },

                    { "id": "default40", "filename": "default", name: '음식점구분',
                        input: [/전단지/, /전단/, /^ㅈㄷㅈ$/],
                        output: '[음식점구분]\n1. 치킨\n2. 중국집\n3. 피자\n4. 족발/보쌈\n5. 패스트푸드\n0. 이전\n!. 처음(주문취소)\n\n목록에서 번호를 입력해주세요~|목록에서 선택해 주세요',
                        children: [
                            { "id": "default41", "filename": "default", input: orderTypes.menuCategoryCheck,
                                ...
                                output: [
                                    {if: 'dialog.task.restaurant && dialog.task.restaurant.length > 0',
                                        ...
                                        children: [
                                            { "id": "default42", "filename": "default", input: {types: [{name: 'orderRestaurant', listName: 'restaurant', typeCheck: 'listTypeCheck'}]},
                                                output: [
                                                    {if: 'context.dialog.orderRestaurant.isOpen == false', output: '현재 영업 시간이 아닙니다.\n0. 이전 \n!. 처음(주문취소)',
                                                        children: [
                                                            { "id": "default43", "filename": "default", input:  [/~이전/, /^0$/], output: {up : 1}},
                                                            { "id": "default44", "filename": "default", input: [/~처음/, /^!$/], output: {call: '주문취소'}}
                                                        ]
                                                    },
                                                    {if: 'true', output: {call: '메뉴선택'}}
                                                ]
                                            },
                                            { "id": "default45", "filename": "default", input: {types: [{type: orderTask.restaurantType, failSave: false}]}, output: {callChild: '음식점입력'}},
                                            {"id": "default46", "filename": "default", output: {repeat: 1, options: {prefix: '목록에 있는 번호나 음식점을 입력해 주세요!\n\n'}}}
                                        ]
                                    },
                                    {if: 'true', output: '[+category+]\n현 주소 근처에서 음식점을 찾지 못했습니다\n0. 이전 \n!. 처음(주문취소)',
                                        children: [
                                            { "id": "default47", "filename": "default", input:  [/~이전/, /^0$/], output: {up : 1}},
                                            { "id": "default48", "filename": "default", input: [/~처음/, /^!$/], output: {call: '주문취소'}}
                                        ]}
                                ]
                            },
                            { "id": "default49", "filename": "default", input: {types: [{type: orderTask.restaurantType, failSave: false}]}, output: {callChild: '음식점입력'}},
                            {"id": "default50", "filename": "default", output: {repeat: 1, options: {prefix: '목록에 있는 번호나 음식점을 입력해 주세요!\n\n'}}}
                        ]
                    },

                    { "id": "default51", "filename": "default", input: {if: 'context.dialog.orderble == undefined && context.dialog.음식점입력최초 == true'},
                        task: {action: function(task, context, callback) {
                    ...
                    { "id": "default52", "filename": "default", output: {call: '음식점입력', options: {output: '"+address.법정읍면동명+ +address.지번본번+-+address.지번부번+" 근처에서 말씀하신 메뉴나 음식점명으로 등록된 음식점이 없는 것 같아요.\n(주문가능 매장은 확대 중입니다.)\n\n다른 메뉴나 음식점을 말씀해 주세요.\n모두 보려면 "전단지"(ㅈㄷㅈ)라고 입력해 주세요~|근처에서 말씀하신걸 못찾았어요. 다른 걸 말씀해주세요.'}}}
                ]
            },

            { "id": "default53", "filename": "default", name: '메뉴선택', input: false,
            ...
            { "id": "default54", "filename": "default", name: '메뉴입력',
                output: '"+orderRestaurant.name+"에서 원하시는 메뉴를 말씀해 주세요.\n모든 메뉴를 보려면 "메뉴판"(ㅁㄴㅍ) 이라고 얘기해주세요|메뉴를 말씀해 주세요',
                children: [
                    { "id": "default55", "filename": "default", input: {if: 'context.dialog.menus && context.dialog.menus.length > 0', regexp: /~네/},
                        output: [
                    ...
                    { "id": "default56", "filename": "default", input: {if: 'context.dialog.menus && context.dialog.menus.length > 0', regexp: /~아니요/}, output: {repeat: 1}},
                    { "id": "default57", "filename": "default", input: {types: [{type: orderTasks.menuType, init: true}], if: 'context.dialog.menu && !Array.isArray(context.dialog.menu)'},
                        task: {action: function(task, context, callback) {context.dialog.orderMenu = context.dialog.menu; callback(task, context);}},
                        output: {call: '메뉴추가확인'}
                    },

                    { "id": "default58", "filename": "default", name: '메뉴목록', input: {types: [orderTasks.menuType], if: 'Array.isArray(context.dialog.menu)'},
                    ...
                    { "id": "default59", "filename": "default", name: '메뉴추가확인',
                        input: false,
                        task: {action: function(task, context, callback) {
                    ...
                    { "id": "default60", "filename": "default", name: '옵션추가확인',
                        input: false,
                    ...
                    { "id": "default61", "filename": "default", name: '메뉴추가확인3',
                        input: false,
                        output: [
                    ...
                    { "id": "default62", "filename": "default", name: '메뉴판',
                        input: [/메뉴판/, /^ㅁㄴㅍ$/, /^ㅁㄴ$/],
                    ...
                    { "id": "default63", "filename": "default", input: '전화', name: '전화주문', output: {text: '음식점 정보를 확인하시고,\n전화로 주문해주세요\n\n음식점명: +orderRestaurant.name+\n주메뉴: +orderRestaurant.category+\n전화번호: +orderRestaurant.phone+', urlMessage: '전화하기', url: 'tel: +orderRestaurant.phone+|전화를 확인하고 주문해주세요'}},
                    { "id": "default64", "filename": "default", input: /^\s*(취소|0)\s*$/g, output: {call: '주문취소'}  },

                    { "id": "default65", "filename": "default", input: {if: 'context.dialog.메뉴입력최초 == true'},
                        task: {action: function(task, context, callback) {context.dialog.메뉴입력최초 = false; callback(task, context);}},
                        output: {call: '메뉴입력'}
                    },

                    { "id": "default66", "filename": "default", output: {call: '메뉴판', options: {prefix: '"+orderRestaurant.name+"에서 말씀하신 메뉴를 찾을 수 없어, 메뉴판을 보여드리겠습니다\n\n'}}}
                ]
            },

            { "id": "default67", "filename": "default", name: '메뉴선택2', input: false,
                output: [
            ...
            { "id": "default68", "filename": "default", name: '메뉴삭제1',
                output: '"+delMenu.name+"를 주문 목록에서 삭제할까요?',
                children: [
                    { "id": "default69", "filename": "default", input: /~네/,
                        task: {action: function(task, context, callback) {
                    ...
                    { "id": "default70", "filename": "default", input: /~아니요/,
                        output: {return: 1, options: {prefix: '+delMenu.name+ 삭제를 취소했습니다.\n\n'}}
                    },
                    { "id": "default71", "filename": "default", output: {repeat: 1, options: {output: '네 또는 아니요로 말씀해주세요.'}}}
                ]
            },

            { "id": "default72", "filename": "default", name: '주문주소확인', input: false,
                output: [
            ...
            { "id": "default73", "filename": "default", name: '주문확인', input: false,
                task: {action: function(task, context, callback) {
                ...
                children: [
                    { "id": "default74", "filename": "default", input: {regexp: /~네/g}, output: {call: '배달주문요청'}  },
                    { "id": "default75", "filename": "default", input: {regexp: /~아니요/g}, output: {returnCall: '주문취소'}  },
                    // { input: {regexp: /(?:~변경|빼다|삭제|취소)/, types: [orderTasks.cartType]},output: {returnCall: '메뉴삭제1'} },
                    { "id": "default76", "filename": "default", output: {repeat: 1, options: {postfix: '\n취소하시려면 "취소"라고 얘기해주세요.'}}}
                ]
            },

            { "id": "default77", "filename": "default", name: '배달주문요청', input: false,
    ...
    {
        "id": "default78", "filename": "default", input: {types: [{name: 'orderble', typeCheck: orderTask.orderableTypeCheck}]},
        output: '배달을 원하시나요?',
        children: [
            { "id": "default79", "filename": "default", input: {regexp: /~네/g}, output: {call: '배달주문'}  },
            { "id": "default80", "filename": "default", input: {regexp: /~아니요/g}, output: '다른 필요하신게 있으시면 말씀해주세요.' }
        ]
    }
];
...
var _bot = require(require('path').resolve("config/lib/bot")).getBot('order3');
