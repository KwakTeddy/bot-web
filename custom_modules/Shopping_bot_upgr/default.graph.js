								...
								"children": [
									{
										...
										"output": [
											{
												"kind": "Action",
												"if": "context.dialog.orderListType.order_simplestatus.search(/배송완료/) != -1",
												"call": "배송완료상품"
											},
											{
												"kind": "Action",
												"if": "context.dialog.orderListType.order_simplestatus.search(/배송중/) != -1",
												"call": "배송중상품"
											},
											{
												"kind": "Action",
												"if": "context.dialog.orderListType.order_simplestatus.search(/배송대기중/) != -1",
												"call": "배송대기중상품"
											}
										]
									},
									...
									},
									{
										...
										"output": {
											"text": "[+orderListType.order_simplestatus+]\n\n+orderListType.order_product+\n\n(*배송 대기 중인 상품은 주문 취소및 변경이 가능합니다. 필요한 경우 1.취소 2.변경 을 입력해주세요)",
											"kind": "Text"
										},
										"children": [
											{
												...
												"output": [
													{
														"text": "[+orderListType.order_simplestatus+] +orderListType.order_product+\n\n위 주문을 취소하겠습니까?",
														"kind": "Text"
													}
												],
												"children": [
...
var _bot = require(require('path').resolve("./engine/core/bot")).getBot('Shopping_bot_upgr');
