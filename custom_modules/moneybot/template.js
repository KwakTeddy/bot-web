...
exports.paramCheck = {
  ...
  path: '/',
  paramDefs: [
    {name: 'domain', display: '도메인', type: 'String', default: 'test', isReuired: true, question: '도메인을 말씀해 주세요.'},
    {name: 'path', display: '경로', type: 'String', default: 'test', isReuired: true, question: '경로를 말씀해 주세요.'}
  ]
}
