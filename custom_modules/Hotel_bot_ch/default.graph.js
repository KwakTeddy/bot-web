    ...
    "children": [
      {
        ...
        "output": [
          {
            "text": "[房间预约进行情况]\n房间预约进行情况\n- 房间种类 : 单间\n- 入住日期 : 2017年 8月4日\n- 退房日期 : 未输入\n\n请输入退房日期或者入住天数.\n(ex. 日期的情况 \"2017-01-01\", 2天3夜的情况 数字 \"3\")",
            "kind": "Text"
          }
        ],
        "children": [
                    ...
                    "children": [
                      {
                        ...
                        "output": [
                          {
                            "text": "[房间预约进行情况]\n房间预约进行情况\n- 房间种类 : 单间\n- 入住日期 : 2017年 8月4日\n- 入住日期 : 2017年 8月 7日\n- 预订人姓名 : 金志燮\n- 预订人联系方式 : 010-9259-7716\n\n上面内容是否正确? 是的话输入 '对', 有想修改的内容的话请输入修正项目的名称.",
                            "kind": "Text"
                          }
                        ],
                        "children": [
                                ...
                                "children": [
                                  {
                                    ...
                                    "output": [
                                      {
                                        "text": "*金志燮* 已经完成预定. 往下列账号汇款 *24万元*完成预订.\n\n国民银行 620-186066-484 moeybrain宾馆",
                                        "kind": "Text"
                                      }
                                    ]
                                  }
