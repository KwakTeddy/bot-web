...
var dialogs = [
{
  ...
  output: '안녕하세요. 배달 주문을 도와주는 얌얌이에요. 주문을 도와드릴까요?',
  children: [
    {
      input: '~네',
...
},
{
  ...
  output: '어떻게 그런 심한 말을! 그렇게 말하시면 얌얌이 힘들어요.'
},
{
  input: ['도움', '돕다', '도우다', '도와줘', '도와주다', 'help', '명령어', '모르다', '모르겠다', '어떡하다'],
  output: '[도움말]\n아래와 같이 편하게 말로 명령해주세요~\n\n[배달]\n비비큐 배달\nBHC 뿌링클 시켜줘\n[내역]\n저번에 먹었던거 시켜줘\n주문 내역 보여줘\n[취소]\n주문 취소해줘\n\n그 외 궁금하신 건 질문하시거나 1577-7314로 연락주세요~'
},
{
  input: ['나이', '몇 살'],
...
{
  input: '사람',
  output: {call: '말돌리기', options: {prefix: '아니에요. 저는 사람이 만든 인공지능 얌얌이에요.\n'}}
},
{
  input: '이름',
  output: {call: '말돌리기', options: {prefix: '제 이름은 얌얌이에요. 성은 없어요.\n'}}
},
{
  input: '영화',
...
{
  input: ['음악', '노래', '가요'],
  output: {call: '말돌리기', options: {prefix: '얌얌이는 요즘 TWICE의 \'TT\'를 즐겨 들어요.\n'}}
},
{
  input: ['꿈', '장래희망'],
...
{
  input: '몸무게',
  output: {call: '말돌리기', options: {prefix: '얌얌이는 가벼워서 한 손에 쏙 들어갈걸요~\n'}}
},
{
  input: ['학교', '초등학생', '대학생', '고등학생', '중학생', '학생'],
  output: {call: '말돌리기', options: {prefix: '얌얌이는 학교에 안 다녀요. 머니브레인의 개발자분들이 저를 가르쳐요.\n'}}
},
{
  input: '직업',
  output: {call: '말돌리기', options: {prefix: '제 직업은 고객님 주문 도와드리기에요.\n'}}
},
{
...
{
  input: '싫다 사람',
  output: {call: '말돌리기', options: {prefix: '얌얌이한테 욕하는 사람! 싫어요.\n'}}
},
{
  input: '특기',
...
var _bot = require(require('path').resolve("./bot-engine/bot")).getBot('order');
