(function()
{
    ...
    Socket.prototype.receive = function(data)
    {
        ...
        var template = '<div class="answer">\n' +
                       '    <img src="https://' +  this.host + '/modules/playchat/simulator/client/imgs/bot.png">\n' +
        ...
        if(output.buttons)
        {
            ...
            for(var i=0; i<output.buttons.length; i++)
            {
                ...
                {
                    html = '<a href="https://' + output.buttons[i].url + '" style="color: #038eda; border: 0;" target="_blank">' + output.buttons[i].text + '</a>' + html;
                }
                else
                {
    ...
    Socket.prototype.init = function()
    {
        ...
        script.src = 'https://' + this.host + '/socket.io/socket.io.js';
        script.onload = function()
        {
            var socket = io('https://'+that.host);
