        ...
        else
        {
            ...
            transaction.done(function()
            {
                ...
                else
                {
                    ...
                    var dialog = bot.dialogMap['noanswer'];
                    Logger.logUserDialog(bot.id, context.user.userKey, context.channel, dialog.input.text, dialog.input.nlpText, dialog.output[0].text, dialog.id, dialog.name, currentDialog.id, currentDialog.name, true, 'dialog');
