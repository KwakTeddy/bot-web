(function()
{
    ...
    //inputRaw, nlp
    SentenceInfo.prototype.analyzeKO = function (morphemes)
    {
    ...
    SentenceInfo.prototype.analyze = function (language, sentence, morphemes)
    {
        var str = sentence;
        ...
        if (language == "ko")
        {
            return this.analyzeKO(morphemes);
        }
        else if (language == "en")
        {
            return this.analyzeEN(morphemes);
        }
        else if (language == "zh")
        {
        ...
        {
            return this.analyzeJA(morphemes);
        }

        return this.type.declarative;
    };

    module.exports = new SentenceInfo();
})();
