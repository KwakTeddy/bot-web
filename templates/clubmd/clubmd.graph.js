...
},
{
  id: 'clubmd22',
  filename: 'clubmd',
  input: ['무엇 서비스', '서비스 알리다', '서비스', '메뉴', '메뉴', '메뉴판', '메뉴 알리다', '메뉴 뭐', '가격', '가격표', '얼마', '비용', '테이블 비', '부스 비'],
