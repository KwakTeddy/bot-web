...
angular.module('template').controller('deliveryBasicController', ['$scope', '$resource', '$cookies', '$stateParams', '$rootScope', function ($scope, $resource, $cookies, $stateParams, $rootScope)
{
