...
{
  id: 'languageacademy15',
  filename: 'languageacademy',
  input: ['강사', '선생님', '인력', '사람', '구성원', '강 사진'],
  ...
  {if: 'context.botUser.isOwner && context.dialog.reserves != undefined', output: '미처리 예약내역입니다.\n#reserves#+index+. +name+ +dateStr+ +time+ [+status+]\n#\n처리할 예약번호를 말씀해주세요.', 
    children: [
    {
      ...
      output: '상세 예약내역입니다.\n상태: +reserve.status+\n예약자명: +reserve.name+\n일시: +reserve.dateStr+ +reserve.time+\n연락처: +reserve.mobile+\n\n"확정", "취소"를 선택해 주세요.', 
        ...
        {
          id: 'languageacademy35',
          filename: 'languageacademy',
          input: '~취소',
          output: '취소 이유를 입력해주세요.', 
            children: [
            {
              id: 'languageacademy34',
              filename: 'languageacademy',
              input: {if: 'true'},
...
{
  id: 'languageacademy60',
  filename: 'languageacademy',
  input: '예약',
  output: {callChild: '날짜선택'}, 
    children: [
    {
      id: 'languageacademy46',
      filename: 'languageacademy',
      name: '날짜선택',
      input: false,
...
var commonDialogs = [
{
  id: 'languageacademycommon0',
  filename: 'languageacademycommon',
  name: '시작',
  input: '시작',
...
},
{
  ...
  children: [
   {
     id: 'languageacademycommon1',
     filename: 'languageacademycommon',
     input: '~네',
     output: '매장 전화번호는 +phone+ 입니다.'
   },
   {
     id: 'languageacademycommon2',
     filename: 'languageacademycommon',
     input: '~아니요',
...
var _bot = require(require('path').resolve("config/lib/bot")).getTemplateBot('languageacademy');
