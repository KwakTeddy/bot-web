...
angular.module('template').controller('hotelFacilityController', ['$scope', '$resource', '$cookies', 'FileUploader','$rootScope', function ($scope, $resource, $cookies, FileUploader,$rootScope)
{
    $scope.$parent.changeWorkingGroundName('컨텐츠 관리 > 시설정보관리', '/modules/playchat/gnb/client/imgs/facility_grey.png');
    ...
    (function()
    {
        ...
        var addUploader = function(index)
        {
            ...
            {
                $scope.datas[index].facility_image = response.url;
            };
        ...
        $scope.add = function()
        {
            $scope.datas.push({ category_name: '',facility_introduction: '',facility_location: '',facility_size: '',facility_number: '', uploader: undefined });
