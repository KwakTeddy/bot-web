...
angular.module('template').controller('flowerServiceAddController', ['$scope', '$resource', '$cookies', '$rootScope','LanguageService','FileUploader',function ($scope, $resource, $cookies,$rootScope,LanguageService, FileUploader)
{
    ...
    (function()
    {
        ...
        {
            $scope.datas.push({ topic:data.topic,name:data.name, picture:data.picture,description:data.description,status:"정상"});
