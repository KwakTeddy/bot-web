'use strict';
angular.module('template').controller('flowerReservationAwaitController', ['$scope', '$resource', '$cookies','$http', 'FileUploader','$location', 'PagingService','LanguageService','$rootScope','DateRangePickerService',function ($scope, $resource, $cookies,  $http, FileUploader,$location,PagingService, LanguageService, $rootScope,DateRangePickerService)
{
