...
var taskModule = require(path.resolve('engine/bot/action/common/task'));
...
var userDilaog = require(path.resolve('engine/user-dialogs/server/controllers/user-dialogs.server.controller'));
var autoCorrection = require(path.resolve('engine/bot/engine/nlp/autoCorrection'));
var quibble = require(path.resolve('engine/bot/engine/dialog/quibbleModule'));
