...
var fileutil = require(path.resolve('./engine/core/action/common/fileutil.js'));
var mongoModule = require(path.resolve('./engine/core/action/common/mongo.js'));
...
var nlp = require(path.resolve('./engine/core/engine/nlp/processor'));
