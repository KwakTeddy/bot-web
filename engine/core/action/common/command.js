...
var bot = require(path.resolve('./engine/core/bot'));
...
function command(inTextRaw, inTextNLP, context, print, callback) {
  ...
  if(cmd.startsWith(':build')) {
    ...
    // utils.requireNoCache(path.resolve('./engine/core/engine/common/globals')).initGlobals();
    // utils.requireNoCache(path.resolve('./engine/core/action/common/dialog'));
