...
var dialog = require(path.resolve('./engine/core/action/common/dialog'));
var async = require('async');
var command = require(path.resolve('./engine/core/action/common/command'));
var factModule = require(path.resolve('./engine/core/action/common/facts'));
var contextModule = require(path.resolve('./engine/core/engine/common/context'));
var dialogsetModule = require(path.resolve('./engine/core/engine/dialogset/dialogset'));

var chatSocketConfig = { port: 1024, host: 'localhost', allowHalfOpen: true };

exports.write = function(channel, from, to, text, json, successCallback)
{
...
var botSocket = undefined;

exports.setBotSocket = function(socket)
{
    botSocket = socket
};
...
function botProc(botName, channel, user, inTextRaw, json, outCallback, options) {
    // TODO 개발용
    dialog = utils.requireNoCache(path.resolve('./engine/core/action/common/dialog'));
    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            var type = utils.requireNoCache(path.resolve('./engine/core/action/common/type'));
