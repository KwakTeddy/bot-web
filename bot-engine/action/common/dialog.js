...
var taskModule = require(path.resolve('./bot-engine/action/common/task'));
...
var userDilaog = require(path.resolve('./bot-engine/user-dialogs.server.controller'));
var autoCorrection = require(path.resolve('./bot-engine/engine/nlp/autoCorrection'));
var quibble = require(path.resolve('./bot-engine/dialog/quibbleModule'));
...
function executeType(inRaw, inNLP, type, task, context, callback)
{
    async.waterfall([
        ...
        function(cb4)
        {
            if(context.dialog.typeMatches == undefined)
                context.dialog.typeMatches = {};
