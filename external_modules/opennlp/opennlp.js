...
var openNLP = function(config) {
    ...
    self.openNLP = {
        jar1: __dirname + "/lib/opennlp-tools-1.6.0.jar",
        jar2: __dirname + '../../../../external_modules/scala-library-2.11.6.jar',
        jar3: __dirname + '../../../../external_modules/twitter-text-1.11.1.jar',
        jar4: __dirname + '../../../../external_modules/korean-text-3.0.jar'
    }
    ...
    // self.java.classpath.splice(0, 0, self.openNLP.jar);
    self.java.classpath.push(self.openNLP.jar1);
    self.java.classpath.push(self.openNLP.jar2);
    self.java.classpath.push(self.openNLP.jar3);
    self.java.classpath.push(self.openNLP.jar4);
